...
public class DocumentServiceImpl implements DocumentService {
    ...
    @Value("${app.storage.allowed-content-types:application/pdf,image/jpeg,image/png,image/jpg}")
    ...
    public DocumentResponse uploadDocument(Integer userId, MultipartFile file, Integer typeId, String description) {
        try {
            // Vérifier si l'utilisateur est actif et validé
            ...
            if (!user.getIsAccountActivated()) {
                throw new IllegalStateException("Account not activated. Please complete your profile first.");
            }
