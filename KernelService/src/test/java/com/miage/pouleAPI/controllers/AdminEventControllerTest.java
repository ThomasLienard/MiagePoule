...
class AdminEventControllerTest {
    ...
    void create_shouldReturn201() {
        CreateEventRequestDTO request = new CreateEventRequestDTO("Event", "Desc", "TRIAL", 1, LocalDateTime.now(), LocalDateTime.now().plusHours(1),2, "Lieu", "Ville", "Rue", "1", "75000", "Infos", 0.0, 0.0, true);
